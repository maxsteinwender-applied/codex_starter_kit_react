...
- For `project_track: coding`, require `stack: react`.
...
3. Line 3: `stack: react` (required only when `project_track: coding`)
...
9. For `project_track: coding`, require `stack: react`; if missing, stop and ask.
