...
- For `project_track: coding`, `stack: react` is required.
...
### Coding track without required stack

Issue:
- `project_track: coding` provided but required React stack line is missing.

Fix:
- Add `stack: react` in line 3.
